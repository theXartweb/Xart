...
<style>
    ...
    .video-card{margin-top:6px;border-radius:14px;overflow:hidden;background:#fff;box-shadow:0 12px 35px rgba(0,0,0,0.06);padding:16px}
    .video-wrap{background:#000;border-radius:10px;overflow:hidden}
    iframe, video{width:100%;height:auto;display:block;border:0;aspect-ratio:16/9;min-height:420px}
...
<main class="container">
    <div class="video-card">
      <div class="video-wrap">
        <iframe
          src="https://player.mediadelivery.net/play/727367/de899abb-421f-49db-aac1-e41b46e99e99"
          loading="lazy"
      ...
      <div class="video-info">
        <h2 class="video-title">Play me - Pornhub.com</h2>
        <p class="video-subtitle">Play me - Pornhub.com.mp4</p>
      </div>
    </div>
